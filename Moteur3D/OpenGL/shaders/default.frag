...
void main() {
    // de par le fonctionnement de nos yeux il n'y a pas de relation linéaire
    // entre la couleur calculée et la couleur affichée
    float gamma = 2.2; // correction des couleur via le paramètre gamma
